	...
	*/
	...
	void createImageViews() {
		...
		for (size_t i = 0; i < swapChainImages.size();i++) {
			...
			// specifies the set of mipmap levels and array layers that the image view will access.
	...
	void copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
		...
		// VK_COMMAND_BUFFER_LEVEL_PRIMARY is used to specify that a command buffer can be submitted to a queue for execution.
